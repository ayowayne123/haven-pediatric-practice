    ...
    <>
      ...
      >
        <div className="container pt-24 flex justify-center items-center flex-col  ">
          <h1 className="mx-auto flex justify-center items-center flex-col text-havenBlue">
            <span>Expert Pediatric Care,</span>
            <span>Every Step of the Way</span>
          </h1>
          <p className="my-8 text-center xl:text-2xl xl:w-[695px] md:text-xl md:w-[600px] 2xl:text-[27px] max-w-[730px]">
      ...
      <section className="lg:my-24 grid lg:grid-cols-7 md:grid-cols-2 gap-8 container">
