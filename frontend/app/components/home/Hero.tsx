    ...
    <>
      ...
      >
        <div className="container pt-24 flex justify-center items-center flex-col">
          {/* Heading */}
          <motion.h1
            className="mx-auto flex flex-col text-havenBlue text-center px-12 md:px-0"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            custom={0}
          ...
          {/* Description */}
          <motion.p
            className="my-8 px-12 md:px-0 text-center xl:text-2xl xl:w-[695px] md:text-xl md:w-[600px] 2xl:text-[27px] max-w-[730px]"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            custom={0.2}
