          ...
          <div className="grid lg:grid-cols-2">
            ...
            <div className="lg:ml-9 my-4 md:my-0 relative text-sm md:text-[22px] leading-[22px] md:leading-[36px] py-3 gap-y-5 lg:py-6 lg:gap-y-6 flex flex-col">
              ...
              {features.map((item, index) => (
                ...
                >
                  {activeIndex === index && (
                    <div className="absolute -left-[2px] w-2 bg-havenPink rounded-2xl transition-all duration-700 h-full top-0" />
                  )}
        ...
        <div className="cardWidth md:overflow-x-auto no-scrollbar">
          <div className="flex md:flex-row flex-col gap-11 w-full lg:mr-20 mr-10">
            <Testimonial
              name="Maryam Sanusi"
              place="(Meatmadamng)"
              bodyText="I no longer have to travel to V.I for pediatric visits. Thanks to Haven pediatric practices located in Ikeja GRA. Beautiful space, warm personnel and brilliant doctors."
            />
            <Testimonial
              name="Anonymous"
              bodyText="Your clinic is beautiful, Your staff are polite, I didn’t feel like i was in Nigeria as they were all very professional."
            />
            <Testimonial
              name="Michael Elisha"
              bodyText="I have spent the past few days at Haven pediatric and I recommend them for any form of pediatric treatment you need for your child or wards. Thank you very much Dr Adegbajo Odedina."
            />
          </div>
        </div>
      </div>
